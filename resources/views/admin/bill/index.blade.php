    ...
    <div class="box-body">
        <div class="box-body table-responsive no-padding">
            ...
            <table id="table-main" class="table table-striped">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="action">
                            <a href="{{url('admin/bill/edit/' . $bill->id)}}" class="btn btn-primary" title="{{trans('common.edit')}}"><i class="fa fa-edit"></i></a>
                            <a href="javascript:;" onclick="deleteModal('{{$bill->id}}', '/admin/bill/destroy')" title="{{trans('common.delete')}}" class="btn btn-danger"><i class="fa fa-trash-o"></i></a>
                        </td>
                    </tr>
                    @endforeach
                    @else 
            ...
            <div class="footer-table">
                <div class="col-sm-6">
                    <span class="total-record">{!!trans("Tổng cộng: <strong>:total</strong> kết quả", ['total' => $bills->total()])!!}</span>
                </div>
                <div class="col-sm-6">
