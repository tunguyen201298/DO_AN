    ...
    <div class="product-item-holder size-big single-product-gallery small-gallery">
        ...
        <div id="owl-single-product" class="owl-carousel owl-theme" style="opacity: 1; display: block;">
            <div class="owl-wrapper-outer">
                <div class="owl-wrapper" style="width: 5742px; left: 0px; display: block; transform: translate3d(-2552px, 0px, 0px); transition: all 200ms ease 0s;">
                    @foreach($product_img as $item)
                    <div class="owl-item" style="width: 319px;">
                        
                        <div class="single-product-gallery-item" id="slide{{$no}}">
                            <a data-lightbox="image-{{$no}}" data-title="Gallery" href="assets\images\products\p8.jpeg">
                                <img class="img-responsive" alt="Ảnh sản phẩm" src="{{ asset('storage/app/products/'.$item->link) }}">
                            </a>
                        </div>
                        @php
                            $no++
        ...
        <div class="single-product-gallery-thumbs gallery-thumbs">
            ...
            <div id="owl-single-product-thumbnails" class="owl-carousel owl-theme" style="opacity: 1; display: block;">
                <div class="owl-wrapper-outer">
                    <div class="owl-wrapper" style="width: 1440px; left: 0px; display: block; transform: translate3d(0px, 0px, 0px);">
                        @foreach($product_img as $item)
                        <div class="owl-item" style="width: 80px;">
                            <div class="item">
                                <a class="horizontal-thumb active" data-target="#owl-single-product" data-slide="{{$no}}" href="#slide{{$no1}}">
                                    <img class="img-responsive" width="85" alt="" src="{{ asset('storage/app/products/'.$item->link) }}">
                                </a>
                            </div>
                        </div>
                        @php
